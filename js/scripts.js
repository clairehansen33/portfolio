...
function myFunction() {
  ...
  if (
    document.body.scrollTop > 76 ||
    document.documentElement.scrollTop > 76
  ) {
    navbar.className = "header" + " nav-bar";
  } else {
    navbar.className = navbar.className.replace(" nav-bar", "");
  }
}
...
// Get the modal
var modal = document.getElementById("petco-hp-desktop-modal");
var modal = document.getElementById("petco-hp-mobile-modal");

// Get the button that opens the modal
var btn = document.getElementById("petco-hp-desktop-btn");
var btn = document.getElementById("petco-hp-mobile-btn");

// Get the <span> element that closes the modal
var span = document.getElementsByClassName("close-petco-hp-desktop")[0];
var span = document.getElementsByClassName("close-petco-hp-mobile")[0];
